...
def count_act_metrics(user, begin, end):
  user_act_metrics = {}
  user_act_metrics['issue_open_cnt'] = 0
  user_act_metrics['issue_close_cnt'] = 0
  user_act_metrics['issue_comment_cnt'] = 0
  user_act_metrics['commit_cnt'] = 0
  user_act_metrics['commit_add_cnt'] = 0
  user_act_metrics['commit_del_cnt'] = 0
